# Architecture — rayls-privacy-tests-automation
...
Sync scripts: `scripts/sync-contracts-local.sh` and `scripts/sync-gnark-verifiers.sh` copy Solidity / verifier artifacts from the local sibling repos (`../rayls-privacy-contracts`, `../rayls-privacy-gnark-api`).
