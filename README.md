...
git clone https://github.com/raylsnetwork/rayls-privacy-contracts
# plus rayls-privacy-relayer-api (brings up the local stack) and rayls-privacy-gnark-api
```

```
projects/
├── rayls-privacy-contracts/
├── rayls-privacy-relayer-api/
└── rayls-privacy-tests-automation/
```
...
> The full list of entries is documented in the relayer repo: `rayls-privacy-relayer-api/docs/dev/README.md`.
...
```bash
cp .env.example .env          # or: cp ../rayls-privacy-contracts/.env ./.env
```
